...
```{r}
#63 AA, 34 AG, 3 GG
#k event of succesess
#$p$ is the proportion of $G$ alleles we have (i.e. the probability of a success), and $n$ is the number of alleles we sample.
n=20
k=20*0.2
...
a=1
b=1
#we can add Beta=(k+a),(n-k+b)

plot(p, dbeta(p,(k+a),(n-k+b)), type = "l", col="blue")
